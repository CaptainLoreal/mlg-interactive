...
(() => {
  ...
  const CLIENTS = [
    ...
    { name: 'BMW Group',        logo: 'bmw.png',                 services: ['Leadership Development', 'Coaching', 'Team Development'],                           meta: 'We collaborate with the MLG on different leadership projects and cultural initiatives. They deliver excellent work! MLG enjoys a great reputation at Munich RE.' },
    ...
    { name: 'Bayer',            logo: 'bayer.png',               services: ['Leadership Development', 'Management Days', 'Coaching', 'Team Development'],        meta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
    ...
    { name: 'Nestlé',           logo: 'nestle.png',              services: [],                                                                                      meta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
    ...
    { name: 'Harman',           logo: 'harman.png',              services: [],                                                                                      meta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
    ...
    { name: 'DVAG',             logo: 'dvag.png',                services: ['Leadership Development'],                                                            meta: 'We are in a complex, vibrant business. I can highly recommend working with MLG in all facets of leadership development and transformation. The MLG experts understand our culture and the business we are in — and based on this, they customize successful measures for fostering our leadership performance.' },
    ...
    { name: 'Exyte',            logo: 'exyte.png',               services: ['Management Days', 'Leadership Development'],                                        meta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
    ...
    { name: 'Deutz',            logo: 'deutz.png',               services: [],                                                                                      meta: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
