...
if (w < 600)  return 1.85;
if (w < 900)  return 2.30;
if (w < 1200) return 2.60;
return 2.80;
}
...
else el.textContent = formatNum(target, useDot) + suffix;
}
...
const count = 40;
const colors = ['#ffffff', '#ffffff', '#B50034'];
const targetX = -originX * 0.85;
const targetY = -originY * 0.80;
...
if (now - lastClickTs > 600) clicks = 0;
lastClickTs = now;
clicks += 1;
if (clicks >= 3 && !rolling) {
clicks = 0;
...
const target = PROFILE_ROUTES[profile] || { slide: 5 };
